...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_pomodoro_del = true;
    ui->screen_wordmeun_del = true;
    ui->screen_wordcard_del = true;
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_reppo(ui);
    lv_scr_load(ui->screen_reppo);
}
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_Acme_Regular_12, LV_PART_MAIN|LV_STATE_DEFAULT);
}
